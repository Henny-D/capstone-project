...
const useWordStore =create ((set, get) => ({
    words:[
            ...
            { word: "imagination", definition: "The faculty or action of forming new ideas, or images or concepts of external objects not present to the senses." },
            { word: "inspiration", definition: "The process of being mentally stimulated to do or feel something, especially to do something creative." },
                { word: "serene", definition: "Calm and peaceful, without worry." },
                { word: "elaborate", definition: "To explain or describe something in detail." },
                { word: "quaint", definition: "Unusual in an old-fashioned or charming way." },
                { word: "peculiar", definition: "Strange or different from what is usual." },
                { word: "vibrant", definition: "Full of life, color, and energy." },
                { word: "melancholy", definition: "A feeling of sadness or being down." },
                { word: "radiant", definition: "Shining brightly, glowing with light." },
                { word: "bewildered", definition: "Confused, not sure what to do." },
                { word: "mysterious", definition: "Something hard to understand or explain." },
                { word: "adventure", definition: "An exciting or unusual experience." },
                { word: "whimsical", definition: "Playful and full of imagination." },
                { word: "bizarre", definition: "Very strange or unusual." },
                { word: "eloquent", definition: "Able to speak or write in a clear, graceful way." },
                { word: "flourish", definition: "To grow or develop in a healthy, strong way." },
                { word: "tranquil", definition: "Calm and peaceful, like a quiet lake." },
                { word: "gleaming", definition: "Shining brightly, like a polished surface." },
                { word: "murmur", definition: "To speak softly or quietly." },
                { word: "vivid", definition: "Very clear and detailed, like a bright picture." },
                { word: "dazzling", definition: "So bright or beautiful that it is hard to look at." },
                { word: "intrigued", definition: "Interested and curious about something." },
                { word: "whirlwind", definition: "A fast-moving storm of wind, spinning around." },
                { word: "mellow", definition: "Soft, calm, and pleasant in taste or sound." },
                { word: "zany", definition: "Funny in a crazy or silly way." },
                { word: "epic", definition: "A very big, grand, and impressive story or event." },
                { word: "flicker", definition: "To shine or burn with an unsteady light." },
                { word: "obscure", definition: "Not well-known or hard to understand." },
                { word: "whimsy", definition: "A playful or fanciful idea." },
                { word: "harmony", definition: "A peaceful combination of different things." },
                { word: "zephyr", definition: "A gentle, soft breeze." },
                { word: "eerie", definition: "Strange and scary, like a ghost story." },
                { word: "pensive", definition: "Thinking deeply or being lost in thought." },
                { word: "labyrinth", definition: "A maze of paths that is hard to get through." },
                { word: "gleeful", definition: "Full of happiness and joy." },
                    { word: "jump", definition: "To push yourself off the ground into the air." },
                    { word: "big", definition: "Larger than usual in size or amount." },
                    { word: "small", definition: "Little in size or amount." },
                    { word: "fast", definition: "Moving quickly." },
                    { word: "slow", definition: "Moving at a low speed." },
                    { word: "bright", definition: "Giving off a lot of light." },
                    { word: "dark", definition: "Having very little or no light." },
                    { word: "hot", definition: "Having a high temperature, like the sun." },
                    { word: "cold", definition: "Having a low temperature, like ice." },
                    { word: "kind", definition: "Being nice and helpful to others." },
                    { word: "brave", definition: "Not afraid to do something hard or scary." },
                    { word: "laugh", definition: "To make a happy sound when something is funny." },
                    { word: "soft", definition: "Feeling gentle or smooth when touched." },
                    { word: "hard", definition: "Not soft; firm and solid." },
                    { word: "tall", definition: "Having a great height." },
                    { word: "short", definition: "Not tall; having a small height." },
                    ...
                    { word: "magic", definition: "Something special that cannot be explained." },
                    { word: "cloud", definition: "A fluffy white shape in the sky." },
                    { word: "ocean", definition: "A very big body of saltwater." },
                    { word: "whisper", definition: "To speak very quietly." },
                    { word: "discover", definition: "To find or learn something new." },
                    { word: "bounce", definition: "To jump up and down on something soft." },
                    { word: "giggle", definition: "A small, happy laugh." },
                    { word: "explore", definition: "To go somewhere new and learn about it." },
                    { word: "zigzag", definition: "To move in a line with sharp turns." },
                    { word: "gentle", definition: "Being soft and careful." },
                    { word: "flutter", definition: "To move quickly, like butterfly wings." },
                    { word: "shiny", definition: "Very bright or reflective." },
                    { word: "hurry", definition: "To move fast because of little time." },
                    { word: "glow", definition: "To give off light or shine softly." },
                    { word: "wonder", definition: "To think about something with curiosity." },
                    { word: "grumpy", definition: "Feeling a little mad or annoyed." },
                    { word: "whistle", definition: "A high sound made with lips or wind." },
                    { word: "tricky", definition: "Something hard to do or figure out." },
                    { word: "mystery", definition: "Something unknown that needs to be solved." },    
                        { word: "jump", definition: "To push yourself off the ground into the air." },
                        { word: "big", definition: "Larger than usual in size or amount." },
                        { word: "small", definition: "Little in size or amount." },
                        { word: "fast", definition: "Moving quickly." },
